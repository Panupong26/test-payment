          ...
          <Transition appear show={showModal} as={Fragment}>
            ...
            >
              ...
              <div className="fixed inset-0 overflow-y-auto">
                <div
                  className={`flex h-full w-full justify-center text-center p-0 ${
                ...
                >
                  ...
                  >
                    <Dialog.Panel className={`transform overflow-hidden bg-gray-100 dark:bg-slate-800 text-left align-middle shadow-xl transition-all w-full h-full`}>
                      <div
                      ...
                      <div
                        className={`px-6 py-8 ${
                          scrollContent ? "overflow-y-auto max-h-full" : ""
                        }`}
                      >
                        {children}
                      </div>
