...
const Header = ({ className = "custom-class" }) => {
  ...
  return (
    <header className={className + " " + navbarTypeClass() } >
      <div
        className={`app-header md:px-6 px-[15px] dark:bg-slate-800 shadow-0 dark:shadow-base3 bg-white w-full
        ${borderSwicthClass()}
             ${
        ...
        <div className="flex justify-between items-center h-full">
          ...
          {menuType === "vertical" && (
            <div className="flex items-center md:space-x-4 space-x-2 rtl:space-x-reverse">
              ...
              {width < breakpoints.xl && width >= breakpoints.md && (
                <div
                  className="cursor-pointer text-slate-800 dark:text-white text-2xl"
          ...
          <div className="nav-tools flex items-center lg:space-x-6 space-x-3 rtl:space-x-reverse">
            ...
            {width <= breakpoints.md && (
              <div
                className="cursor-pointer text-slate-500 dark:text-white text-2xl"
                onClick={handleOpenMobileMenu}
              >
                <Icon icon="heroicons-outline:menu-alt-3" />
              </div>
