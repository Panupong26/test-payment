              ...
              <div>
                ...
                >
                  <span
                    className={`${
                      activeMultiMenu === j
                        ? " bg-slate-900 dark:bg-slate-300 ring-4 ring-opacity-[15%] ring-black-100 dark:ring-slate-300 dark:ring-opacity-20"
                        : ""
                ...
                {({ isActive }) => (
                  ...
                  >
                    <span
                      className={`${
                        isActive
                          ? " dark:bg-blue-300 ring-0 ring-opacity-[15%] ring-blue-400 dark:ring-sky-300 dark:ring-opacity-20"
                          : ""
                      } h-2 w-2 rounded-full border border-gray-700 dark:border-white inline-block flex-none`}
                    ></span>
                    <span className="flex-1">{subItem.childtitle}</span>
                  </span>
                )}
