          ...
          <Card className=' rounded-2xl mt-4'>
            <Row gutter={16}>
              <Col xs={24} sm={12} md={24}>
                ...
                >
                  เลือกใบอนุญาตที่ต้องการต่ออายุ
                  {isLoading && (
            ...
            <Row gutter={[16, 8]}>
              <Col xs={24} sm={12} md={24}>
                ...
                >
                  ...
                  >
                    <li>
                      หนังสือรับรองว่าได้ผ่านการฝึกอบรมและทดสอบความรู้ความสามารถในการเป็นมัคคุเทศก์ที่ออกโดยกรมการท่องเที่ยว
                    </li>
                  </ul>
                </Card>
              </Col>
...
export default GuideFormRenewalPage;
