          ...
          <Card className=' rounded-2xl mt-4 '>
            <Row gutter={16}>
              <Col xs={24} sm={12} md={24}>
                ...
                >
                  เลือกใบอนุญาตที่ต้องการขอรับใบแทน
                  {isLoading && (
                        ...
                        <div className='flex gap-4'>
                          ...
                          <div className='flex-1'>
                            ...
                            <div className='mt-2 text-sm text-secondary-500'>
                              โปรดเลือกใบอนุญาตที่ต้องการขอใบแทน
                            </div>
                          </div>
                        </div>
                  ...
                  <div>
                    ...
                    <Row gutter={16}>
                      <Col xs={24} sm={12} md={12}>
                        <div>
                          <Text>
                            มีความประสงค์ขอรับใบแทนใบอนุญาตเป็นมัคคุเทศก์เนื่องจาก
                          </Text>
                        </div>
                        <Select
    ...
    <div>
      <div className='bg-blue-900 sm:h-auto md:h-[70px] mb-6 flex items-center justify-center '>
        <h4 className='text-title font-bold text-center text-white '>
          ยื่นคำขอรับใบแทนใบอนุญาตเป็นมัคคุเทศก์
        </h4>
      </div>
...
export default GuideFormReplacingPage;
