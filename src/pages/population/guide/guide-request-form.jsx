          ...
          <Card className='rounded-2xl mt-4'>
            <Row gutter={16}>
              <Col xs={24} sm={12} md={24}>
                ...
                >
                  เลือกข้อมูลการทดสอบความรู้ความสามารถ
                  {isLoading && (
                        ...
                        <div className='flex gap-4'>
                          ...
                          <div className='flex-1'>
                            ...
                            <div className='mt-2 text-sm text-secondary-500'>
                              โปรดเลือกข้อมูลการทดสอบความรู้ความสามารถ
                            </div>
                          </div>
                        </div>
            ...
            <>
              ...
              <div className='sm:hidden'>
                ...
                >
                  ...
                  <option value={3}>ข้อมูลการศึกษาและอบรม</option>
              ...
              <div className='py-3'>
                ...
                <div style={{ display: activeTab === 3 ? 'block' : 'none' }}>
                  <div>
                    ...
                    <p className='text-lg text-gray-900 dark:text-white'>
                      ได้รับวุฒิบัตร ผ่านการอบรมมัคคุเทศก์
                    </p>
                    <Row gutter={16}>
                      <Col xs={24} sm={12} md={24}>
                        <Form.Item
              ...
              <div style={{ display: activeTab === 4 ? 'block' : 'none' }}>
                <div className='text-card-body pl-4'>
              ...
              <Col xs={24} sm={12} md={24}>
                ...
                >
                  <ul
                    ...
                    className='marker:text-blue-800 list-disc ps-5 space-y-2 text-sm text-gray-600 dark:text-gray-400'
                  >
                    <li>หลักฐานการศึกษาอย่างใดอย่างหนึ่ง ดังต่อไปนี้</li>
                  </ul>
                  <Card
                  ...
                  >
                    ...
                    และสำเนาใบแสดงผลหรือรายงานผลการศึกษา
                  </Card>
                  <Card
                    className='rounded-2xl border border-blue-100 shadow-sm'
                    style={{
                  ...
                  >
                    (ข) สำเนาอนุปริญญาบัตร ประกาศนียบัตรวิชาชีพชั้นสูง
                    หรือหนังสือรับรองว่าสำเร็จการศึกษาระดับอนุปริญญาหรือประกาศนียบัตรวิชาชีพชั้นสูง
                    สาขามัคคุเทศก์หรือสาขาการท่องเที่ยว
                    ที่มีวิชาเกี่ยวกับมัคคุเทศก์
                    และสำเนาใบแสดงผลหรือรายงานผลการศึกษา
                  </Card>
                  <Card
                    className='rounded-2xl border border-blue-100 shadow-sm'
                  ...
                  >
                    (ค)
                    สำเนาวุฒิบัตรหรือหนังสือรับรองที่ออกโดยกรมการท่องเที่ยวว่าได้ผ่านการฝึกอบรม
                    หลักสูตรวิชามัคคุเทศก์
                  </Card>
                </Card>
                ...
                >
                  ...
                  >
                    <ul
                      role='list'
                      className='marker:text-blue-400 list-disc ps-5 space-y-2 text-sm text-gray-600 dark:text-gray-400'
                    >
                      <li>
                        หนังสือรับรองผลการทดสอบความรู้ความสามารถในการเป็นมัคคุเทศก์
                        ที่ออกโดยกรมการท่องเที่ยวพร้อมสําเนา
                      </li>
                    </ul>
                  </Card>
                  <Card
                  ...
                  >
                    ...
                    >
                      <li>
                        เอกสารรับรองผลการทดสอบ (Verifiable Credential : VC)
                      </li>
                    </ul>
                  </Card>
                </Card>
    ...
    <div>
      ...
      <div className='bg-blue-900 sm:h-auto md:h-[70px] mb-6 flex items-center justify-center '>
        <h4 className='text-title font-bold text-center text-white '>
          ยื่นคำขอใบอนุญาตเป็นมัคคุเทศก์
        </h4>
      </div>

      {/*   <div className='bg-blue-900 h-[80px] mb-6'>
        <div className='mx-auto max-w-screen-xl px-4 pb-4 pt-4 sm:px-6 lg:px-8 lg:pt-10'>
...
export default GuideFormRequestPage;
