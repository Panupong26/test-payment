...
const IndividualFormRequestPage = () => {
  ...
  const steps = [
            ...
            <>
              ...
              <div className='py-3'>
                ...
                <div style={{ display: activeTab === 1 ? 'block' : 'none' }}>
                  <div>
                    <Checkbox onChange={''} className='mb-4'>
                      ให้บริการดำน้ำ
                    </Checkbox>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    >
                      <div className='flex items-center gap-2'>
                        ...
                        <p className='text-gray-700'>
                          หนังสือค้ำประกันของธนาคาร (แบงค์การันตี)
                        </p>
                      </div>
    ...
    {
      title: 'เจ้าหน้าที่ตรวจสอบ',
      description: 'เจ้าหน้าที่ตรวจสอบหลักประกัน',
      content: (
        <div>
          <Card className='my-custom-card-body rounded-2xl'>
            <Row gutter={16}>
          ...
          >
            ...
            >
              <dl className='grid sm:grid-cols-3 gap-1 sm:gap-2'>
                <dt className='sm:col-span-1 font-semibold text-gray-900 text-right'>
                  สถานะ :
                </dt>
                <dd className='col-start-2 col-span-2 text-blue-800'>
                  เจ้าหน้าที่กำลังตรวจสอบหลักประกัน
                </dd>

                <dt className='sm:col-span-1 font-semibold text-gray-900 text-right'>
                  จำนวนเงิน :
                </dt>
                <dd className='col-start-2 col-span-2'>30,000 บาท</dd>
                  ...
                  <div className='flex flex-col bg-white border border-gray-200 shadow-sm rounded-xl p-4 md:p-5 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400'>
                    <div>
                      <dl className='grid sm:grid-cols-3 gap-1 sm:gap-2'>
                        ...
                        <dd className='col-start-2 col-span-2'>2,000</dd>
                        <dt className='sm:col-span-1 font-semibold text-gray-600 text-right'>
                          ค่าจัดส่ง :
                        </dt>
...
export default IndividualFormRequestPage;
