...
const IndividualFormrRplacingPage = () => {
                        ...
                        <div className='flex gap-4'>
                          ...
                          <div className='flex-1'>
                            ...
                            <div className='mt-2 text-sm text-secondary-500'>
                              โปรดเลือกใบอนุญาตที่ต้องการขอใบแทนใบอนุญาตประกอบธุรกิจนำเที่ยว
                            </div>
                          </div>
                        </div>
                  ...
                  <div>
                    ...
                    <Row gutter={16}>
                      <Col xs={24} sm={12} md={12}>
                        <div>
                          <Text>
                            มีความประสงค์ขอใบแทนใบอนุญาตประกอบธุรกิจนำเที่ยวเนื่องจาก
                          </Text>
                        </div>
                      ...
                      >
                        <Option value='ชำรุด' className='custom-select-option'>
                          ชำรุด
                        </Option>
                        <Option
    ...
    <div>
      <div className='bg-blue-900 sm:h-auto md:h-[70px] mb-6 flex items-center justify-center '>
        <h4 className='text-title font-bold text-center text-white '>
          ยื่นคำขอใบแทนใบอนุญาตประกอบธุรกิจนำเที่ยว (บุคคลธรรมดา)
        </h4>
      </div>
...
export default IndividualFormrRplacingPage;
