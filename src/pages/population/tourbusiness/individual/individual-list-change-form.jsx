...
const IndividualFormListchangePage = () => {
  ////////////////////////////////////////////////////
...
*/
  ...
  const steps = [
                        ...
                        <div className='flex gap-4'>
                          ...
                          <div className='flex-1'>
                            ...
                            <div className='mt-2 text-sm text-secondary-500'>
                              โปรดเลือกใบอนุญาตที่ต้องการเปลี่ยนแปลงรายการ
                            </div>
                          </div>
                        </div>
    ...
    {
      title: 'กรอกข้อมูล',
      description: 'ข้อมูลการเปลี่ยนแปลง',
      content: (
        <div>
          <Card className='my-custom-card-body rounded-2xl '>
            <Row gutter={16}>
      ...
      <Card
        ...
        title={
          <div className='card-title'>
            <p>มีความประสงค์ขอเปลี่ยนแปลงรายการใบอนุญำตประกอบธุรกิจนำเที่ยว</p>
          </div>
        }
        style={{
          marginTop: 16,
                  ...
                  <div>
                    ...
                    >
                      <div className='flex items-center gap-2'>
                        ...
                        <p className='text-gray-700'>เพิ่มสํานักงานสาขา</p>
                      </div>
                  ...
                  <div>
                    ...
                    >
                      <div className='flex items-center gap-2'>
                        ...
                        <p className='text-gray-700'>ลดสํานักงานสาขา</p>
                      </div>
                  ...
                  <div>
                    ...
                    >
                      <div className='flex items-center gap-2'>
                        ...
                        <p className='text-gray-700'>เปลี่ยนแปลงชื่อ-สกุล</p>
                      </div>
                      <p className='text-green-400'>ไม่มีค่าธรรมเนียม</p>
                    </label>
                  </div>
                ...
                <Card className='rounded-2xl border border-blue-200 mt-4 shadow-sm'>
                  ...
                  >
                    <li>
                      ...
                      และใบอนุญาตประกอบธุรกิจนําเที่ยวสาขา{' '}
                    </li>
                  </ul>
                </Card>
                <Card className='rounded-2xl border border-blue-200 mt-4 shadow-sm'>
...
export default IndividualFormListchangePage;
