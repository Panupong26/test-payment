...
const ServicePage = () => {
  ...
  const pdfFiles = [
    { name: 'สำเนาบัตรประจำตัวประชาชน', url: '/example.pdf' },
    /* { name: 'สำเนาทะเบียนบ้าน', url: '/example.pdf' }, */
    // รายการ PDF อื่นๆ
  ];
  ...
  const handleClosePdf = () => {
    setCurrentPdfUrl(null); // ปิด PDF โดยการตั้ง URL เป็น null
  };
                  ...
                  <tbody className='divide-y divide-gray-100 border-t border-gray-100'>
                    {currentItems.map((item) => (
                      ...
                      >
                        ...
                        <td className='px-4 py-4 text-sm'>
                          {item.status_id === 1 ? (
                            <span className='inline-flex items-center gap-1 rounded-full bg-yellow-50  text-xs font-semibold text-yellow-600'>
                              <svg
                                xmlns='http://www.w3.org/2000/svg'
                                viewBox='0 0 20 20'
                                fill='currentColor'
                        ...
                        <td className='px-4 py-2'>
                          <div>
                            <span className='inline-flex overflow-hidden rounded-xl border bg-white '>
                              <Tooltip placement='top' title='รับเรื่อง'>
                                <div>
                                  <button className='inline-block border-e p-3 text-gray-700 hover:bg-gray-50 focus:relative'>
                                    <svg
                                      xmlns='http://www.w3.org/2000/svg'
                                      width='20'
                                      height='20'
                              ...
                              <Modal
                                ...
                                label={
                                  <Tooltip placement='top' title='รายละเอียด'>
                                    <div>
                                      <button className='inline-block border-e p-3 text-gray-500 hover:bg-gray-50 focus:relative'>
                                        <svg
                                          xmlns='http://www.w3.org/2000/svg'
                                          width='20'
                                          height='20'
                                ...
                                <div className='mx-auto max-w-screen-xl px-4 pb-6 pt-4 sm:px-4 lg:px-2 lg:pt-0'>
                                    ...
                                    <Col xs={24} sm={12} md={24}>
                                      <div className='flex justify-between'>
                                        <div className='text-body-page text-body-size '>
                                          <button
                                            type='button'
                                            className='w-32 h-10 rounded-xl border border-primary-600 bg-primary-600 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-primary-700 hover:bg-primary-700 focus:ring focus:ring-primary-200 disabled:cursor-not-allowed disabled:border-primary-300 disabled:bg-primary-300'
                                          >
                                            <p>รับเรื่อง</p>
                                          </button>
                                        </div>
                                  ...
                                  <Row gutter={16}>
                                    <Col
                                      ...
                                      xl={16}
                                    >
                                      <div className='flex flex-col h-screen mb-16 text-body-page'>
                                        <Card
                                          title={
                                          ...
                                          className='rounded-2xl mt-4 shadow-md flex-grow p-2'
                                        >
                                          <div className='flex ...'>
                                              ...
                                              {pdfFiles.map((pdf, index) => (
                                                <div>
                                                  <button
                                                    key={index}
                                                    onClick={() =>
                                                      handleShowPdf(pdf.url)
                                                    }
                                                  >
                                                    <img
                                                      src={file2Img}
                                                      alt=''
                                                      className='h-8 w-8 block object-cover rounded-full border hover:border-white border-transparent'
                                                    />
                                                    {pdf.name}
                                                  </button>
                                                </div>
                                            ...
                                            <div className='flex-none w-48 h-14'>
                                              <div>
                                                <button
                                                  type='button'
                                                  className='mr-4 rounded-lg border border-primary-100 bg-primary-100 px-5 py-2.5 text-center text-sm font-medium text-primary-600 transition-all hover:border-primary-200 hover:bg-primary-200 focus:ring focus:ring-primary-50 disabled:border-primary-50 disabled:bg-primary-50 disabled:text-primary-400'
                                                >
                                                  อนุมัติ
                                                </button>
                                                ...
                                                <button
                                                  type='button'
                                                  className='rounded-lg border border-gray-300 bg-transparent px-5 py-2.5 text-center text-sm font-medium text-gray-700 shadow-none transition-all hover:bg-gray-100 disabled:bg-transparent disabled:text-gray-400'
                                                >
                                                  ปฎิเสธ
                                                </button>
                                              </div>
                                          ...
                                          <div className='flex justify-between'>
                                            <div className='text-body-page text-body-size'>
                                              {currentPdfUrl && (
                                                <section className='px-4 py-10 bg-white mx-auto max-w-4xl absolute top-0 right-0 left-0'>
                                                  <div>
                                                    <button
                                                      onClick={handleClosePdf}
                                                      className='absolute top-0 right-0 pb-12 mr-3 text-black pt-4'
                                                    >
                                                      <svg
                                                        xmlns='http://www.w3.org/2000/svg'
                                                        width='24'
                                    ...
                                    <Col xs={24} sm={10} md={8}>
                                      <Card className='rounded-2xl mt-4 shadow-md flex-grow'>
                                        <div className='space-y-4 text-body-page text-body-size'>
