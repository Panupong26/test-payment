              ...
              <summary className=' flex items-center justify-between gap-1.5'>
                <div className='text-th'>
                  <h4 className='font-bold '>
                    ยื่นคำขอใบอนุญาตประกอบธุรกิจนำเที่ยว (บุคคลธรรมดา)
                  </h4>
                </div>
        ...
        <Card className=' rounded-2xl mt-4 text-body-page text-body-size'>
          <>
            ...
            <div className='sm:hidden'>
              ...
              >
                <option value={0}>รายละเอียดบุคคลธรรมดา</option>
                        ...
                        <Col xs={24} sm={12} md={24} key={index}>
                          ...
                          >
                            ...
                            <Row gutter={16}>
                              ...
                              <Col xs={24} sm={12} md={8}>
                                <Form.Item
                                  name={`province_id_branch_${index}`}
                                  label='จังหวัด'
                                  rules={[{ required: false }]}
                                >
                                  <Input type='text' placeholder='จังหวัด' />
                              ...
                              <Col xs={24} sm={12} md={8}>
                                <Form.Item
                                  name={`district_id_branch_${index}`}
                                  label='เขต/อำเภอ'
                                  rules={[{ required: false }]}
                                >
                                  <Input placeholder='เขต/อำเภอ' />
                            ...
                            <Row gutter={16}>
                              <Col xs={24} sm={12} md={8}>
                                <Form.Item
                                  name={`subdistrict_id_branch_${index}`}
                                  label='แขวง/ตำบล'
                                  rules={[{ required: false }]}
                                >
                                  <Input placeholder='แขวง/ตำบล' />
