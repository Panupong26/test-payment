                      ...
                      <Row gutter={16} style={{ marginTop: 8 }}>
                        <Col xs={24} sm={24} md={24} lg={24}>
                          <div>
                            ...
                            <label
                              htmlFor='Local'
                              className='mb-4 flex cursor-pointer items-center justify-between rounded-lg border border-gray-100 bg-white p-4 text-sm font-medium shadow-sm hover:border-gray-200 peer-checked:border-blue-500 peer-checked:ring-1 peer-checked:ring-blue-500'
                            >
