...
const TourBusinessSuspensionPage = () => {
        ...
        <Row gutter={16}>
          <Col xs={24} sm={24} md={18}>
            <div className='text-th'>
              <h5 className='font-bold text-blue-900'>
                รายการพักใช้ใบอนุญาตธุรกิจนำเที่ยว
              </h5>
            </div>
          </Col>
          <Col xs={24} sm={24} md={6} lg={6}>
            <div className='grid justify-items-end'>
              ...
              >
                <span className='font-bold '>+ เพิ่มข้อมูลพักใช้ใบอนุญาต</span>
              </button>
            </div>
          </Col>
        </Row>
      ...
      <Card className='rounded-2xl shadow-sm mt-4'>
                            ...
                            <Row gutter={16}>
                              ...
                              <Col xs={24} sm={12} md={12}>
                                ...
                                >
                                  ...
                                  > */}
                                    <Select.Option
                                      value='พักใช้ใบอนุญาต'
                                      className='custom-select-option'
                                    >
                                      พักใช้ใบอนุญาต
                                    </Select.Option>
                                    <Select.Option
                                      value='ยกเลิกการพักใช้'
                                      className='custom-select-option'
                                    >
                                      ยกเลิกการพักใช้
                                    </Select.Option>
                                    <Select.Option
                                      value='ครบกำหนดการพักใช้'
                                      className='custom-select-option'
                                    >
                                      ครบกำหนดการพักใช้
                                    </Select.Option>
                                    <Select.Option
                                      value='อยู่ระหว่างการดำเนินการพักใช้'
                                      className='custom-select-option'
                                    >
                                      อยู่ระหว่างการดำเนินการพักใช้
                                    </Select.Option>
                                  </Select>
                                </Form.Item>
                              </Col>
        ...
        <Drawer
          ...
          footer={
            ...
            >
              <div className=''>
                <Link to='/tourbusiness-suspension-license'>
                  <button
                    type='button'
        ...
        >
          <Form layout='vertical' size='large'>
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name='province_id' label='ประเภทใบอนุญาต'>
                  <Input type='text' placeholder='ธุรกิจนำเที่ยว' />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name='province_id' label='เลขที่ใบอนุญาต'>
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name='province_id' label='ชื่อธุรกิจนำเที่ยว'>
                  <Input type='text' placeholder='ชื่อธุรกิจนำเที่ยว' />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name='province_id' label='เลขที่นิติบุคคล'>
                  <Input type='text' placeholder='เลขที่นิติบุคคล' />
                </Form.Item>
              </Col>
            </Row>
            <Row gutter={16}>
                                          ...
                                          >
                                            ...
                                            >
                                              <Space direction='vertical'>
                                                ...
                                                <Radio value={4}>
                                                  อยู่ระหว่างการดำเนินการพักใช้การพักใช้
                                                </Radio>
                                              </Space>
                                            </Radio.Group>
                                          </Form.Item>
...
export default TourBusinessSuspensionPage;
