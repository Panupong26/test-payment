...
const TourleaderSuspensionPage = () => {
        ...
        <Row gutter={16}>
          <Col xs={24} sm={12} md={18}>
            <div className='text-th'>
              <h5 className='font-bold text-blue-900'>
                รายการตักเตือนและสั่งระงับหรือแก้ไขการกระทำผู้นำเที่ยว
              </h5>
            </div>
          </Col>
          <Col xs={24} sm={24} md={6} lg={6}>
            <div className='grid justify-items-end'>
              ...
              >
                <span className='font-bold '>+ เพิ่มข้อมูลการตักเตือนฯ</span>
              </button>
            </div>
          </Col>
        </Row>
      ...
      <Card className='rounded-2xl shadow-sm mt-4'>
        ...
        <Drawer
          ...
          footer={
            ...
            >
              <div className=''>
                <Link to='/tourleader-suspension-license'>
                  <button
                    type='button'
          ...
          <Form layout='vertical' size='large'>
            <Row gutter={16}>
              <Col span={12}>
                ...
                >
                  <Input type='text' placeholder='ผู้นำนำเที่ยว' />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item
...
export default TourleaderSuspensionPage;
