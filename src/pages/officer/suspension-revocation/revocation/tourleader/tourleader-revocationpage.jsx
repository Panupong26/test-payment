...
const TourleaderRevocationPage = () => {
        ...
        <Row gutter={16}>
          <Col xs={24} sm={12} md={17}>
            <div className='text-th'>
              ...
              รายการคำสั่งห้ามปฏิบัติหน้าที่หรือเพิกถอนการจดทะเบียนผู้นำเที่ยว
              </h5>
            </div>
          </Col>
          ...
          <div className="grid justify-items-end">
            <button
              ...
              type='button'
              className='w-68 text-body-page rounded-full border border-primary-600 bg-primary-600 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-primary-700 hover:bg-primary-700 focus:ring focus:ring-primary-200 disabled:cursor-not-allowed disabled:border-primary-300 disabled:bg-primary-300'
            >
              <span className='font-bold '>+ เพิ่มข้อมูลเพิกถอนการจดทะเบียน</span>
            </button>
            </div>
          </Col>
        </Row>
      ...
      <Card className='rounded-2xl shadow-sm mt-4'>
        ...
        <Drawer
          ...
          footer={
            ...
            >
              <div className=''>
                <Link to='/tourleader-revocationpage-license'>
                  <button
                    type='button'
...
export default TourleaderRevocationPage;
