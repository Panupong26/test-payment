...
const BranchofficecomplainPage = () => {
        ...
        <div className='mb-4'>
          <Row gutter={[16, 8]}>
            ...
            <Col xs={24} sm={24} md={8} lg={5}>
              <NavLink to='/branch-write-complaint' className='text-blue-900'>
                <button
                  /* onClick={showDrawerAdd} */
                  type='button'
                  className='w-full text-body-page rounded-full border border-primary-600 bg-primary-600 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-primary-700 hover:bg-primary-700 focus:ring focus:ring-primary-200 disabled:cursor-not-allowed disabled:border-primary-300 disabled:bg-primary-300'
                >
                  <p className='font-bold'>+ เพิ่มข้อมูลเรื่องร้องเรียน</p>
                </button>
              </NavLink>
            </Col>
          </Row>
...
export default BranchofficecomplainPage;
