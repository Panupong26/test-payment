...
const ImportData = () => {
  ...
  const data = Array.from({ length: 30 }, (_, index) => ({
    ...
    state: index % 2 === 0 ? 'ปกติ' : 'พักใช้ใบอนุญาต',
  }));
      ...
      <Card className='rounded-2xl'>
        <div class='flex items-center justify-between '>
          <div className='text-th'>
            <h4 className='font-bold'>นำเข้าข้อมูล</h4>
          </div>
          ...
          <div className='text-body-page'>
            <button
              onClick={showDrawer}
              type='button'
              class='rounded-full border border-primary-600 bg-primary-600 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-primary-700 hover:bg-primary-700 focus:ring focus:ring-primary-200 disabled:cursor-not-allowed disabled:border-primary-300 disabled:bg-primary-300'
            >
